...
```{r blood_loss_1, fig.height=5, fig.width=12, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r blood_loss_2, fig.asp=1 ,fig.height=1, fig.width=10, echo=FALSE, message=FALSE, warning=FALSE}
blood <- subset(h1, outcome=='blood loss')
...
```{r hospital1, fig.height=5, fig.width=13, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r hospital2, fig.height=5, fig.width=15, echo=FALSE, message=FALSE, warning=FALSE}
hospital <- subset(h1, outcome=='Hospital stay')
