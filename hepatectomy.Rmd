...
```{r blood_loss_1, fig.height=5, fig.width=13, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r blood_loss_2, fig.height=5, fig.width=15, echo=FALSE, message=FALSE, warning=FALSE}
blood <- subset(h1, outcome=='blood loss')
